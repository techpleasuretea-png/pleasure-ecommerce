...
export function Features() {
    return (
        <div className="hidden md:block mx-auto max-w-[1600px] px-4 md:px-8 my-16">
            <ScrollReveal mode="fade-up" width="100%">
                <section className="bg-primary/5 dark:bg-primary/10 rounded-3xl p-8 md:p-12">
                    <div className="grid md:grid-cols-3 gap-8 text-center">
                        <ScrollReveal mode="fade-up" delay={0.1} className="flex flex-col items-center">
                        ...
                        <ScrollReveal mode="fade-up" delay={0.2} className="flex flex-col items-center">
                            <div className="bg-primary text-white w-16 h-16 rounded-full flex items-center justify-center shadow-lg shadow-primary/30 mb-4">
                        ...
                        <ScrollReveal mode="fade-up" delay={0.3} className="flex flex-col items-center">
                            <div className="bg-primary text-white w-16 h-16 rounded-full flex items-center justify-center shadow-lg shadow-primary/30 mb-4">
