...
export function Footer() {
    return (
        <>
            ...
            <footer className="hidden md:block bg-surface pt-16 pb-8 border-t border-border">
                <div className="mx-auto max-w-[1600px] px-4 md:px-8">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
                        ...
                        <div>
                            ...
                            <div className="flex">
                                <input
                                    className="w-full text-sm rounded-l-lg border-y border-l border-input bg-background px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all"
