                    ...
                    <table className="w-full text-left border-collapse">
                        <thead>
                            <tr className="border-b border-gray-100 dark:border-gray-800 bg-gray-50/50 dark:bg-gray-800/10">
                                ...
                                <th className="p-4 text-xs font-bold text-subtext-light dark:text-subtext-dark uppercase tracking-wider">Items</th>
                                <th className="p-4 text-xs font-bold text-subtext-light dark:text-subtext-dark uppercase tracking-wider">Payment</th>
                        ...
                        <tbody className="divide-y divide-gray-100 dark:divide-gray-800">
                            {orders && orders.length > 0 ? (
                                orders.map((order: any) => {
                                    ...
                                    return (
                                        <tr key={order.id} className="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors group">
                                            ...
                                            <td className="p-4 text-sm text-subtext-light dark:text-subtext-dark capitalize">
                                ...
                                <tr>
                                    <td colSpan={8} className="p-8 text-center text-subtext-light dark:text-subtext-dark">
                                        No orders found.
                                    </td>
                                </tr>
                            )}
